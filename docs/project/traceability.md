...
| REQ-CORE-003 | M1.1/M2.1 specs and ADR 0009 | Python/Rust protocol modules, disabled M2 stage-one through stage-eleven pipeline, and distinct non-authorizing public result APIs | shared v1 conformance plus all 252 frozen M2 cases at their assigned boundaries; 49 stage-eleven statuses/codes/decisions/anchors and exact public result shapes match | partial |
