...
| REQ-CORE-003 | M1.1/M2.1 specs and ADR 0009 | Python/Rust protocol modules, disabled M2 stage-one through stage-eleven pipeline, closed result constructors, private conformance inspectors, and distinct non-authorizing public result APIs | shared v1 conformance plus all 252 frozen M2 cases at their assigned boundaries; 49 stage-eleven statuses/codes/decisions/anchors, exact public result shapes, replay-snapshot mutation regression, and public-surface tests match | partial |
