...
| REQ-CORE-003 | M1.1/M2.1 specs and ADR 0009 | Python/Rust protocol modules and disabled M2 stage-one through stage-six inspector | shared v1 conformance plus all 237 M2 cases classified through the signature boundary in both runtimes | implemented |
